...
density_specific_trait_orchard <- orchard_plot(Specific_Trait_Model, group = "Study_ID", mod = "Measurement", xlab = TeX(" Effect Size ($PRRD_{S}$)"), angle = 45, k = FALSE, g = FALSE) + ylim(-0.2, 0.2) + 
                  my_theme() + 
                  annotate('text',  x = c(1,2,3,4)+0.1, y = 0.18, label= paste("italic(k)==", c(specific_trait_table["Development Time", "K"],
                                              specific_trait_table["Length", "K"],
                                              specific_trait_table["Mass", "K"],
...
terrestrial_trait_rnames_2 <- c("Morphological", "Physiological")
...
terrestrial_trait_raw_name_2 <- c(replicate(46, "Morphological"),
                                  replicate(18, "Physiological"))
...
Terrestrial_Trait_Order_2 <- c("Physiological", "Morphological")
...
developmental_trait_rnames_2 <- c("Morphological")
...
developmental_trait_raw_name_2 <- c(replicate(54, "Morphological"))
...
Developmental_Trait_Order_2 <- c("Morphological")
...
density_developmental_trait_2 <- developmental_trait_table_2 %>% mutate(name = fct_relevel(name, Developmental_Trait_Order_2)) %>%
                                 ...
                                 label= paste("italic(k)==", c(developmental_trait_table_2["Morphological", "K"]), "~","(", 
                                                             c(developmental_trait_table_2["Morphological", "group_no"]), 
                                              ")"), parse = TRUE, hjust = "right", size = 3.5) +
                                  geom_label(aes(label=c(paste(format(round(mean(exp(Developmental_Trait_Model_Estimates["Morphology", "estimate"])-1)*100, 2), nsmall = 2), "%")), 
